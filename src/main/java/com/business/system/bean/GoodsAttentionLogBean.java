 ...
 * @author system
 * @since 2017-02-24 20:24:19
 */
@Table(name = "GOODS_ATTENTION_LOG", description = "商家关注记录信息表")
public class GoodsAttentionLogBean {

	/** 评论编号 */
	@Column(pk = true, name = "ATTENTION_NO", type = Type.定长文本, description = "评论编号", canNull = false, size = 32, policy = "UUID")
	...
	/** 等级 */
	@Column(name = "ATTENTION_STATUS", type = Type.数字整型, description = "等级", canNull = false)
	private int grade;
