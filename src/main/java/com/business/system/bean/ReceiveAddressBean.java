...
public class ReceiveAddressBean {
	...
	/** 收货地址编号 */
	@Column(pk = true, name = "ADDRESS_NO", type = Type.定长文本, description = "收货地址编号", canNull = false, size = 32, policy = "UUID")
	private String addressNo;

	/** 收货地址名称 */
	@Column(name = "ADDRESS_NAME", type = Type.变长文本, description = "收货地址名称", canNull = false, size = 50)
	private String addressName;

	/** 收货地址 */
	@Column(name = "ADDRESS_CONTENT", type = Type.变长文本, description = "收货地址", canNull = false, size = 250)
	private String content;

	/** 排序 */
	@Column(name = "ADDRESS_ORDER", type = Type.数字整型, description = "排序", canNull = false)
	private int order;

	/** 收货人 */
	@Column(name = "RECEIVER", type = Type.变长文本, description = "收货人", canNull = false, size = 50)
	...
	/** 备注 */
	@Column(name = "REMARK", type = Type.变长文本, description = "备注", canNull = false, size = 250)
