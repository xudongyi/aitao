...
<div class="top-search" id="queryForm">
	...
	<input id="goodsNo" class="mini-combobox" name="goodsNo" style="width:150px;" textField="goodsName" valueField="goodsNo" emptyText="请选择..."
	 	url="${ctx}/goods/totalList.do?sellerNo=<%=request.getParameter("sellerNo") %>" showNullItem="true" nullItemText="请选择...">
	<label>评论等级：</label>
...
<div class="mini-fit">
	<div id="datagrid" class="mini-datagrid" style="width:100%;height:100%;" pageSize="20" 
		 url="${ctx}/goods/comment/sellerList.do?sellerNo=<%=request.getParameter("sellerNo") %>"  idField="id" allowResize="true" allowSortColumn="false">
		 <div property="columns">
       	<div type="indexcolumn"></div>
       	<div field="commentNo" visible="false"></div>
       	<div field="goodsNo" width="120" headerAlign="center" align="center" >商品名称</div>
